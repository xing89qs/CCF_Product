...
- 算法说明
	...
	- 考虑到评价标准是**MPSE**，我们首先对label进行 **log transformation** 即![equation](http://latex.codecogs.com/gif.latex? y^{'} = log(x+1) )，预测后再使用![equation](http://latex.codecogs.com/gif.latex? y^{predict} = exp(y^{'}) - 1 )变换回来
		- 但是效果提升不大
